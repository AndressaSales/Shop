...
export default function Kids(){
    ...
    return(
       <div className="md:mt-32 mt-20 max-w-7xl mx-auto">
            ...
            <div className="mx-auto max-w-7xl px-4 py-16 sm:pt-24 lg:max-w-7xl lg:px-8">
                <h2 className="text-2xl font-bold tracking-tight text-gray-900 text-center md:text-start">Coleção Infantil</h2>
                <div className="mt-6 grid grid-col-1 gap-x-6 gap-y-10 px-6 md:px-0 sm:grid-cols-2 lg:grid-col-4 xl:gap-x-8">
                    {
