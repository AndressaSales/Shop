...
export default function BannerPart01(){
    return(
        <div className="bg-gray-100 pt-40">
            <div className="relative max-w-7xl mx-auto pt-20 md:rounded-2xl bg-cover bg-center h-[550px] md:h-[600px]" style={{backgroundImage: `url(${banner})`}} >
